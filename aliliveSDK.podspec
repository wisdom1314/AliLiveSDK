...
Pod::Spec.new do |spec|
  ...
  spec.name         = "aliliveSDK"
  spec.version      = "0.0.1"
  spec.summary      = "flutter iOS aliliveSDK."
  ...
  spec.author             = { "zhangzhihui" => "1728171899@qq.com" }
  # Or just: spec.author    = "zhangzhihui"
  # spec.authors            = { "zhangzhihui" => "1728171899@qq.com" }
  # spec.social_media_url   = "https://twitter.com/zhangzhihui"
